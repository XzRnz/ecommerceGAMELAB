...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('assets/images/logogmlab.png')}}">
    <link rel="icon" href="{{asset('assets/images/logogmlab.png')}}" type="image/x-icon">
    ...
    <meta name="apple-mobile-web-app-title" content="EcommerceGamelab">
    <meta name="msapplication-TileImage" content="{{asset('assets/images/logogmlab.png')}}">
    <meta name="msapplication-TileColor" content="#FFFFFF">


    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="EcommerceGamelab">
    <meta name="keywords" content="EcommerceGamelab">
    <meta name="author" content="EcommerceGamelab">
    <link rel="preconnect" href="https://fonts.gstatic.com">

    <title>Ecommerce gamelab</title>
                            ...
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{route('app.index')}}">
                                        <img src="{{asset('assets/images/logogmlab.png')}}" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="{{route('app.index')}}" class="footer-logo float-start">
                                    <img src="{{asset('assets/images/logogmlab.png')}}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                            <ul class="contact-lists" style="clear:both;">
                                ...
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@gamelab.id</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
